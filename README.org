...
Inline formatting tokens within a line (ignored inside --beginoutput/--beginshelloutput):

--b ... --/b: bold
--u ... --/u: underline
--rev ... --/rev: reverse video
--c <color> ... --/c: color (same names as --color)
\--b (or any \--) escapes the token and prints it literally.
